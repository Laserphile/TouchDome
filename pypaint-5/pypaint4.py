...
"""
pypaint4.py
Step 4 in bulding a comprehensive paint program in pygame

This script adds extra functionality to the basic class
1.. Increase the screen to a more practical size 800x600
2.. Add a work canvas to display temporary drawing actions, such as outlines
    Since a paint program is not a high speed game, we can use a few
    ovelayed canvases to give us what we need.
3.. Add a simple line tool and manage its mouse events
4.. We add a draw list and class of items that are to be blitted onto the canvas
5.. We changed the mouse handler
6.. We create a paint canvas for our actual painting
